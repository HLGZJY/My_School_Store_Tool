...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__5005951",
    appName: "My_School_Store_Tool",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/admin/wc-test",
    style: {
      navigationBarTitleText: "微信采集测试",
      navigationBarBackgroundColor: "#07C160",
      navigationBarTextStyle: "white"
    }
  },
  {
    path: "pages/admin/review",
    style: {
      navigationBarTitleText: "文章审核",
      navigationBarBackgroundColor: "#FFFFFF",
      navigationBarTextStyle: "black"
    }
  },
  {
    path: "pages/admin/sources",
    style: {
      navigationBarTitleText: "数据源管理",
      navigationBarBackgroundColor: "#FFFFFF",
      navigationBarTextStyle: "black"
    }
  },
  ...
  {
    path: "pages/admin/url-fetch",
    style: {
      navigationBarTitleText: "URL抓取测试",
      navigationBarBackgroundColor: "#07C160",
      navigationBarTextStyle: "white"
    }
  },
  {
    path: "pages/admin/simple-fetch",
    style: {
      navigationBarTitleText: "简化抓取测试",
      navigationBarBackgroundColor: "#07C160",
      navigationBarTextStyle: "white"
    }
  }
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/icons/tabbar/discover-active.png"
    },
    {
      pagePath: "pages/mine/mine",
      text: "我的",
      iconPath: "static/icons/tabbar/mine.png",
      selectedIconPath: "static/icons/tabbar/mine-active.png"
    }
  ]
};
const globalStyle = {
  navigationBarTextStyle: "black",
  navigationBarTitleText: "校园信息聚合",
  navigationBarBackgroundColor: "#FFFFFF",
  backgroundColor: "#F7F9FA"
};
const uniIdRouter = {};
